...
def main_results(df, bcs, trim_value, iv_flag, cluster_school):
 ...
 #RUN FIRST STAGE FOR MATCHING REGRESSIONS line 293
   ...
   # First, ensure 'school_id' and 'year' are available and then create 'school_year_group'
    ...
    # Save the results DataFrame to a CSV file before returning from the function
    results_df.to_csv('regression_results.csv', index=False)

    # Conditional operation, can be adjusted or used before saving if it affects 'df'
    if 3 == 0:  # This condition seems like it will never be true; adjust as necessary
